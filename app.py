...
start_index = None 
n_months  = None
start_index = st.slider('Start index',  min_value=0, max_value=df.shape[37101], step=1)
n_months  = st.slider('Number of months',  min_value=2,  max_value=df.shape[37150]-start_index, step=1)
